...
const { mrTemplates, mrTemplatesMsk,
  rdsPostgres, rdsRecommendInstanceTypesInDev } = require('./constants');
...
const welcomeMsg = input => {
  if (input && input.url !== 'undefined') {
    markdown(`Hey there! Thanks for contributing a PR to a repo! 🎉. [review url](${input.url})`)
  } else {
